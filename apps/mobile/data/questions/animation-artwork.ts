...
export const ANIMATION_ARTWORK_QUESTIONS: Question[] = [
  ...
  },
  {
    id: 'purple-mc-001',
    category: 'purple',
    questionText: 'Which studio produced the animated film "Spirited Away"?',
    answerText: 'Studio Ghibli',
    difficulty: 'easy',
    choices: ['Pixar', 'Studio Ghibli', 'DreamWorks', 'Madhouse'],
    correctChoiceIndex: 1,
  },
  {
    id: 'purple-mc-002',
    category: 'purple',
    questionText: 'What art movement is Salvador Dalí most associated with?',
    answerText: 'Surrealism',
    difficulty: 'medium',
    choices: ['Cubism', 'Impressionism', 'Surrealism', 'Abstract Expressionism'],
    correctChoiceIndex: 2,
  },
  {
    id: 'purple-mc-003',
    category: 'purple',
    questionText: 'In "Spider-Man: Into the Spider-Verse", what is Miles Morales\'s home dimension?',
    answerText: 'Earth-1610',
    difficulty: 'hard',
    choices: ['Earth-616', 'Earth-1610', 'Earth-65', 'Earth-928'],
    correctChoiceIndex: 1,
  },
];